...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'apps.users.AuthenticationClasses.HeaderAuthentication',
        'apps.users.AuthenticationClasses.CookieAuthentication',
        'apps.users.AuthenticationClasses.BodyAuthentication',
    ],
